...
import com.jacobknowlton.cents.budget.repository.mapper.BudgetTagMapper
import com.jacobknowlton.cents.generated.budget.model.BudgetTransaction
import com.jacobknowlton.cents.budget.repository.mapper.BudgetTransactionMapper
...
class BudgetTransactionRepository(
    ...
    fun findById(id: Long): BudgetTransaction? {
        return dsl.select(
            ...
            ).convertFrom { r -> r.map(BudgetTagMapper) }.`as`(BUDGET_TRANSACTION_TAGS_FIELD),
        )
            ...
            .fetchOne(BudgetTransactionMapper)
    }
}
