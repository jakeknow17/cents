...
fun generateModelClass(schema: KotlinSchema, basePackage: String, outputDir: File) {
    ...
    // Package declaration
    modelSb.appendLine("// This file is generated by the Cents code generator.")
    modelSb.appendLine()
...
fun generateRequestClass(schema: KotlinSchema, basePackage: String, outputDir: File) {
    val modelSb = StringBuilder()
    // Package declaration
    modelSb.appendLine("// This file is generated by the Cents code generator.")
    modelSb.appendLine()
        ...
        inDir.walkTopDown()
            ...
            .forEach { file ->
                ...
                for (schema in schemas) {
                    ...
                    generateRequestClass(schema, basePackage, outputRoot.asFile)
                }
